...
?>
<form class="was-validated"  method="POST" action="<?php echo URL?>actividadesdeportivas/actualizar" novalidate id="save_img" enctype="multipart/form-data" autocomplete="off">
